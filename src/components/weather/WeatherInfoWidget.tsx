...
export const WeatherInfoWidget= ({ localWeather }: {localWeather: WeatherResponse}) => {
    ...
    return (
        <div className="h-3/5 w-3/5 lg:w-1/5 bg-gradient-to-r from-slate-700/50 to-slate-700/60 absolute flex flex-row justify-content text-gray-50/80 p-0 shadow">
            <div className={`bg-gradient-to-r from-slate-800/50 to-slate-800/80 flex flex-row flex-wrap mx-4 my-4 justify-content w-full shadow-md border ${borderStyle}`}>
